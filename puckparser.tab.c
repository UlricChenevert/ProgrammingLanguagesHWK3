...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_K_IF = 6,                       /* K_IF  */
  YYSYMBOL_K_THEN = 7,                     /* K_THEN  */
  YYSYMBOL_K_ELSE = 8,                     /* K_ELSE  */
  YYSYMBOL_K_SC = 9,                       /* K_SC  */
  YYSYMBOL_K_WHILE = 10,                   /* K_WHILE  */
  YYSYMBOL_K_DO = 11,                      /* K_DO  */
  YYSYMBOL_K_END = 12,                     /* K_END  */
  YYSYMBOL_K_LPAREN = 13,                  /* K_LPAREN  */
  YYSYMBOL_K_RPAREN = 14,                  /* K_RPAREN  */
  YYSYMBOL_K_WRITE = 15,                   /* K_WRITE  */
  YYSYMBOL_OP_ASSIGN = 16,                 /* OP_ASSIGN  */
  YYSYMBOL_OP_NEG = 17,                    /* OP_NEG  */
  YYSYMBOL_OP_RELATION = 18,               /* OP_RELATION  */
  YYSYMBOL_OP_ADD = 19,                    /* OP_ADD  */
  YYSYMBOL_OP_MULT = 20,                   /* OP_MULT  */
  YYSYMBOL_T_IDENT = 21,                   /* T_IDENT  */
  YYSYMBOL_YYACCEPT = 22,                  /* $accept  */
  YYSYMBOL_StatementSequence = 23,         /* StatementSequence  */
  YYSYMBOL_Statement = 24,                 /* Statement  */
  YYSYMBOL_WhileStatement = 25,            /* WhileStatement  */
  YYSYMBOL_IfStatement = 26,               /* IfStatement  */
  YYSYMBOL_WriteStatement = 27,            /* WriteStatement  */
  YYSYMBOL_Assignment = 28,                /* Assignment  */
  YYSYMBOL_Factor = 29,                    /* Factor  */
  YYSYMBOL_Term = 30,                      /* Term  */
  YYSYMBOL_SimpleExpression = 31,          /* SimpleExpression  */
...
{
       0,    49,    49,    51,    54,    56,    58,    60,    64,    66,
      68,    71,    74,    77,    78,    79,    80,    81,    82,    84,
      85,    87,    88,    90,    91
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_INTEGER",
  "T_DECIMAL", "T_STRING", "K_IF", "K_THEN", "K_ELSE", "K_SC", "K_WHILE",
  "K_DO", "K_END", "K_LPAREN", "K_RPAREN", "K_WRITE", "OP_ASSIGN",
  "OP_NEG", "OP_RELATION", "OP_ADD", "OP_MULT", "T_IDENT", "$accept",
  "StatementSequence", "Statement", "WhileStatement", "IfStatement",
  "WriteStatement", "Assignment", "Factor", "Term", "SimpleExpression",
...
{
      17,     1,     1,   -11,   -13,     9,     4,   -25,   -25,   -25,
     -25,   -25,   -25,   -25,     1,     1,   -25,   -10,    -3,    -1,
      18,    13,     1,     1,   -25,    17,    12,   -25,     1,     1,
       1,    17,    17,    15,   -25,   -25,   -25,   -25,   -25,   -25,
       3,    19,   -25,    17,   -25,   -25,    21,   -25
};
...
{
       0,     0,     0,     0,     0,     0,     2,     7,     6,     5,
       4,    13,    14,    15,     0,     0,    16,    19,    21,    23,
       0,     0,     0,     0,     1,     0,     0,    18,     0,     0,
       0,     0,     0,     0,    12,     3,    17,    20,    22,    24,
       0,     0,    11,     0,     9,     8,     0,    10
};
...
{
      21,    35,    22,    23,    11,    12,    13,    40,    41,    24,
      28,    43,    26,    25,    14,    44,    29,    30,    15,    46,
      33,    34,    16,     1,    32,    31,    36,     2,    39,    42,
      37,    45,     3,    47,    38,    27,     0,     0,     4
};

static const yytype_int8 yycheck[] =
{
       2,    25,    13,    16,     3,     4,     5,    31,    32,     0,
      20,     8,    14,     9,    13,    12,    19,    18,    17,    43,
      22,    23,    21,     6,    11,     7,    14,    10,    30,    14,
      28,    12,    15,    12,    29,    15,    -1,    -1,    21
};
...
{
       0,     6,    10,    15,    21,    23,    24,    25,    26,    27,
      28,     3,     4,     5,    13,    17,    21,    29,    30,    31,
      32,    32,    13,    16,     0,     9,    32,    29,    20,    19,
      18,     7,    11,    32,    32,    23,    14,    30,    31,    32,
      23,    23,    14,     8,    12,    12,    23,    12
};
